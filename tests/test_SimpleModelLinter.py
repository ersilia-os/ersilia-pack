...
class TestSimpleModelLinter:
  ...
  def test_metadata_existence(self, linter):
    ...
    metadata_exists = os.path.exists(os.path.join(MODEL_PATH, "metadata.yml")) or os.path.exists(os.path.join(MODEL_PATH, "metadata.json"))
  ...
  def test_install_file_existence(self, linter):
    ...
    install_exists = os.path.exists(os.path.join(MODEL_PATH, "install.yml")) or os.path.exists(os.path.join(MODEL_PATH, "Dockerfile"))
